    ...
    return (
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow">
            <div className="flex justify-between items-center mb-4">
                <div>
                    <h3 className="text-lg font-bold text-gray-800">Riwayat Absensi Siswa</h3>
                    <p className="text-sm text-gray-500">{dateRange}</p>
                </div>
                {/* Tombol Navigasi sekarang memanggil fungsi yang benar */}
                <div className="flex items-center space-x-2">
                    <button onClick={handlePrevWeek} className="p-1.5 rounded-full hover:bg-gray-200 transition-colors" aria-label="Minggu Sebelumnya">
                    ...
                    <button onClick={handleNextWeek} className="p-1.5 rounded-full hover:bg-gray-200 transition-colors" aria-label="Minggu Selanjutnya">
